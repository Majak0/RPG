...
let cat4 = ['clothes', 'potion', 'weapon'];
...
let shop10 = new Shop("Luis Withon",cat4);
let shop11 = new Shop("Shop",cat4);
let shop12 = new Shop("Coca Channel",cat4);
let shop13 = new Shop("Guinguette",cat4);
let street4 = new Street("Da Ghetto");
...
var team = [
    new Perso("Conan",1), new Perso("Xena",2), new Perso("Bertrand", 420)
];
export {town, team}